...
export class Backend implements backendInterface {
    ...
    async getAllReasonCards(): Promise<Array<LoveReasonCard>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllReasonCards();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getCardContent(): Promise<CardContent> {
        if (this.processError) {
            try {
                const result = await this.actor.getCardContent();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getLoveLetter(): Promise<string> {
        if (this.processError) {
            try {
    ...
    async getPhotoCaptions(): Promise<PhotoCaptions> {
        if (this.processError) {
            try {
                const result = await this.actor.getPhotoCaptions();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getReasonCard(arg0: bigint): Promise<LoveReasonCard> {
        if (this.processError) {
            try {
                const result = await this.actor.getReasonCard(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
